...
public class NewsapiAiApiService : INewsService
{
    private readonly HttpClient _httpClient;
    private readonly ILogger<CryptopanicApiService> _logger;

    public NewsapiAiApiService(IHttpClientFactory httpClientFactory, ILogger<CryptopanicApiService> logger)
    {
        _logger = logger;
        //_httpClient = httpClientFactory.CreateClient(HttpClientNames.NewsapiAi);
    }
